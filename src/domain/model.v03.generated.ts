/* Generated from schemas/map-0.3.schema.json. Run npm run schema:generate; do not edit. */
...
/**
 * This interface was referenced by `YardMap`'s JSON-Schema
 * via the `definition` "RoadSpan".
 */
export type RoadSpan =
  | {
      kind: 'line';
    }
  | {
...
/**
 * This interface was referenced by `YardMap`'s JSON-Schema
 * via the `definition` "RoadGeometry".
 */
...
export interface Facility {
  name: string;
  kind: 'workshop' | 'yard' | 'assembly' | 'dock' | 'quay' | 'other' | 'building';
  boundary: Polygon;
