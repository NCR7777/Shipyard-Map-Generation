...
const GESTURES: [string, string][] = [
  ...
  ['Shift+点击', '增减选择'], ['空白处拖动', '框选：左→右完整包含，右→左相交'], ['Alt+点击', '在重叠对象之间循环（控制柄上另有含义，见下）'],
  ...
  ['道路控制柄', '黄色折点移动，Alt+点击删除；橙色菱形拖动成曲线，双击拉直；蓝色调切向；绿色宽度柄记为人工影像估计宽度'],
  ['双击已选中的道路', '在双击处插入折点（曲线段按原形拆开，路形不变）；要先点选这条道路，未选中时双击只是选中'],
